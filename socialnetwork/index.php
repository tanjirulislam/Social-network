...
<h2> this is a heading2 </h2>
    ...
    <h1>Welcome to Our SocialNetwork</h1>
    <div class="container">
        <div class="tab">
            <button class="tablink active" onclick="openTab(event,'signin')" id="link1">Student Id</button>
            <button class="tablink" onclick="openTab(event,'signup')" id="link2">Student Sign Up</button>
        </div>
        <div class="content">
